...
if __name__ == "__main__":
    from nsgaii_for_SEIMS.nsga2_deap.deap import base, creator
    from nsgaii_for_SEIMS.nsga2_deap.deap import benchmarks
    from nsgaii_for_SEIMS.nsga2_deap.deap import creator
