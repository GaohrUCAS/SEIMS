...
extern "C" SEIMS_MODULE_API const char *MetadataInformation()
{
	...
	mdi.AddParameter(VAR_A_DAYS, UNIT_NON_DIM, DESC_A_DAYS, Source_ParameterDB, DT_Single);
	mdi.AddParameter(VAR_B_DAYS, UNIT_NON_DIM, DESC_B_DAYS, Source_ParameterDB, DT_Single);
